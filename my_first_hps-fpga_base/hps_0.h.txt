...
/*
 * Macros for device 'pio_instruction', class 'altera_avalon_pio'
 * The macros are prefixed with 'PIO_INSTRUCTION_'.
 * The prefix is the slave descriptor.
 */
#define PIO_INSTRUCTION_COMPONENT_TYPE altera_avalon_pio
#define PIO_INSTRUCTION_COMPONENT_NAME pio_instruction
#define PIO_INSTRUCTION_BASE 0x0
#define PIO_INSTRUCTION_SPAN 16
#define PIO_INSTRUCTION_END 0xf
#define PIO_INSTRUCTION_BIT_CLEARING_EDGE_REGISTER 0
#define PIO_INSTRUCTION_BIT_MODIFYING_OUTPUT_REGISTER 0
#define PIO_INSTRUCTION_CAPTURE 0
#define PIO_INSTRUCTION_DATA_WIDTH 32
#define PIO_INSTRUCTION_DO_TEST_BENCH_WIRING 0
#define PIO_INSTRUCTION_DRIVEN_SIM_VALUE 0
#define PIO_INSTRUCTION_EDGE_TYPE NONE
#define PIO_INSTRUCTION_FREQ 50000000
#define PIO_INSTRUCTION_HAS_IN 0
#define PIO_INSTRUCTION_HAS_OUT 1
#define PIO_INSTRUCTION_HAS_TRI 0
